...
class Validator extends Component
{
     ...
     * @param \Reaction\Base\Model $model the data model being validated
     * @param string $attribute the name of the attribute to be validated.
     * @param \Reaction\Web\View $view the view object that is going to be used to render views or view files
     ...
     * @param \Reaction\Base\Model $model the model being validated
    ...
    /**
     * Formats a message using the I18N, or simple strtr if `\Reaction::$app` is not available.
    ...
    {
        // TODO: Add working i18n component
        /*if (\Reaction::$app !== null) {
            return \Reaction::$app->getI18n()->format($message, $params, \Reaction::$app->language);
        }*/
