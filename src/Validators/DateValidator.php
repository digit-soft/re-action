...
class DateValidator extends Validator
{
     ...
     * Default value will be determined from different formats of the formatter class,
    ...
    public function init()
    {
        ...
        if ($this->min !== null && is_string($this->min)) {
            $timestamp = $this->parseDateValueFormat($this->min, $this->format);
            if ($timestamp === false) {
    ...
    public function validateAttribute($model, $attribute)
    {
        ...
        $timestamp = $this->parseDateValueFormat($value, $this->format);
        if ($timestamp === false) {
