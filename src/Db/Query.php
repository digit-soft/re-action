...
class Query extends Component implements QueryInterface, ExpressionInterface
{
     ...
     * @param DatabaseInterface $db the database connection. If not set, the "db" application component will be used.
...
PATTERN;
     ...
     * @return string
     */
    protected function ensureNameQuoted($name)
    {
     ...
     * Use 0 to indicate that the cached data will never expire.
     * Use a negative number to indicate that query cache should not be used.
     * Use boolean `true` to indicate that [[DatabaseInterface::queryCacheDuration]] should be used.
     * Defaults to `true`.
     * @return $this the Query object itself
     */
