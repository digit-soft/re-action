...
abstract class BaseActiveRecord extends Model implements ActiveRecordInterface
{
    ...
    {
        $this->emit(self::EVENT_AFTER_FIND, [&$this]);
    }
    ...
    {
        $eventName = $insert ? self::EVENT_AFTER_INSERT : self::EVENT_AFTER_UPDATE;
        $this->emit($eventName, [&$this, $changedAttributes]);
    }
    ...
    {
        $this->emit(self::EVENT_BEFORE_DELETE, [&$this]);
    }
    ...
    {
        $this->emit(self::EVENT_AFTER_REFRESH, [&$this]);
    }
    ...
    public function link($name, $model, $extraColumns = [])
    {
        ...
        if ($relation->via !== null) {
            ...
            if (is_array($relation->via)) {
                ...
                $record = \Reaction::create($viaClass);
