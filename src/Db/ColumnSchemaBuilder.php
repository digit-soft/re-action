...
class ColumnSchemaBuilder extends BaseObject
{
    ...
    /**
     * @var DatabaseInterface the current database connection. It is used mainly to escape strings
     ...
     * @param DatabaseInterface $db the current database connection. See [[$db]].
