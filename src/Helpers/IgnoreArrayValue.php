 ...
 *         2,
 *     ],
 *     'validDomains' => new \Reaction\Helpers\ReplaceArrayValue([
 *         'example-second.com',
 *         'www.example-second.com',
 *     ]),
 * ];
 *
 * $result = \Reaction\Helpers\ArrayHelper::merge($array1, $array2);
 * ```
 *
 * The result will be
 *
