...
class FileHelper
{
     ...
     */
    public static $mimeMagicFile = '@reaction/Helpers/mimeTypes.php';
    /**
     * @var string the path (or alias) of a PHP file containing MIME aliases.
     */
    public static $mimeAliasesFile = '@reaction/Helpers/mimeAliases.php';
    ...
    {
        if ($language === null) {
            $language = \Reaction::$app->language;
        }
    ...
    public static function createDirectory($path, $mode = 0775, $recursive = true)
    {
        ...
        try {
            ...
            if (!is_dir($path)) {// https://github.com/yiisoft/yii2/issues/9288
                throw new \Reaction\Exceptions\Exception("Failed to create directory \"$path\": " . $e->getMessage(), $e->getCode(), $e);
            }
        }
        try {
            return chmod($path, $mode);
        } catch (\Exception $e) {
            throw new \Reaction\Exceptions\Exception("Failed to change permissions for directory \"$path\": " . $e->getMessage(), $e->getCode(), $e);
        }
    }
