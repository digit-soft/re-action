...
class Modal extends Widget
{
    ...
    public function init()
    {
        ...
        echo $this->htmlHlp->beginTag('div', $modalDialogOptions) . "\n";
        echo $this->htmlHlp->beginTag('div', ['class' => 'modal-content']) . "\n";
    ...
    {
        return $this->htmlHlp->beginTag('div', $this->bodyOptions);
    }
    ...
    protected function renderToggleButton()
    {
        if (($toggleButton = $this->toggleButton) !== false) {
            ...
            return $this->htmlHlp->tag($tag, $label, $toggleButton);
        } else {
            return null;
        }
    }
    ...
    protected function renderCloseButton()
    {
        if (($closeButton = $this->closeButton) !== false) {
            ...
            $label = $this->htmlHlp->tag('span', $label, ['aria-hidden' => 'true']);
