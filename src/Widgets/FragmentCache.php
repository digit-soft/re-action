<?php
//TODO: Come back if there will be some SYNC! cache component. Not used for now!

namespace Reaction\Widgets;

use Reaction;
use Reaction\Base\DynamicContentAwareInterface;
use Reaction\Base\DynamicContentAwareTrait;
...
/**
 * FragmentCache is used by [[\Reaction\Base\View]] to provide caching of page fragments.
 *
