 ...
 */
class ActiveField extends Reaction\Base\RequestAppComponent
{
    /**
     ...
     *   See also [[\Reaction\Helpers\Html::tag()]].
     *
    ...
    {
        /* @var $class \Reaction\Base\Widget */
    ...
    protected function getClientOptions()
    {
        ...
        if ($clientValidation) {
            ...
            foreach ($this->model->getActiveValidators($attribute) as $validator) {
                /* @var $validator Reaction\Validators\Validator */
