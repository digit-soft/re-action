...
class MessageFormatter extends Component
{
     ...
     * @throws \Reaction\Exceptions\NotSupportedException when PHP intl extension is not installed.
     */
     ...
     * @throws \Reaction\Exceptions\NotSupportedException when unsupported formatting is used.
     */
