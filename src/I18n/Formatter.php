...
use Reaction\Helpers\HtmlPurifier;
 ...
 * You can access that instance via `Reaction::$app->formatter`.
 *
...
class Formatter extends Component
{
     ...
     * The array has third boolean element indicating whether the timestamp has date information
     ...
     * @param array $options optional configuration for the number formatter. This parameter will be merged with [[numberFormatterOptions]].
     * @param array $textOptions optional configuration for the number formatter. This parameter will be merged with [[numberFormatterTextOptions]].
     * @return array [parameters for Reaction::t containing formatted number, internal position of size unit]
     * @throws InvalidArgumentException if the input value is not numeric or the formatting failed.
     */
