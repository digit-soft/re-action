 ...
 * @property \Reaction\Web\View $view The view object that can be used to render views or view files. Note that the
...
class Widget extends RequestAppComponent implements ViewContextInterface
{
     ...
     * @return \Reaction\Web\View the view object that can be used to render views or view files.
     */
