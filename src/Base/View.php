...
use Reaction\Widgets\FragmentCache;
...
class View extends Component implements ViewInterface, DynamicContentAwareInterface
{
    ...
    {
        $viewFile = \Reaction::$app->getAlias($viewFile);
        ...
        if (isset($this->renderers[$ext])) {
            if (is_array($this->renderers[$ext]) || is_string($this->renderers[$ext])) {
                $this->renderers[$ext] = \Reaction::create($this->renderers[$ext]);
            }
    ...
    {
        $this->emit(self::EVENT_BEFORE_RENDER, [$this, $viewFile, $params]);
    }
    ...
    {
        $this->emit(self::EVENT_AFTER_RENDER, [$this, $viewFile, $params, &$output]);
    }
    ...
    public function beginPage()
    {
        ...
        $this->emit(self::EVENT_BEGIN_PAGE, [$this]);
    }
