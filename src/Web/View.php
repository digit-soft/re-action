 ...
 *
 * @property \Reaction\Web\AssetManager $assetManager The asset manager. Defaults to the "assetManager" application
 * component.
 *
 * Borrowed from yii2
 */
class View extends \Reaction\Base\View implements RequestComponentInterface
{
    ...
    public function beginBody()
    {
        ...
        $this->emit(self::EVENT_BEGIN_BODY, [$this]);
    }
    ...
    {
        $this->emit(self::EVENT_END_PAGE, [$this]);
     ...
     * @return \Reaction\Web\AssetManager the asset manager. Defaults to the "assetManager" application component.
     */
     ...
     * @param \Reaction\Web\AssetManager $value the asset manager
     */
    ...
    {
        $this->metaTags['csrf_meta_tags'] = $this->renderDynamic('return Reaction\Helpers\Html::csrfMetaTags();');
    }
